...
const Prizes = () => {
  return (
    <div className="min-h-screen md:pb-0 pb-24 flex justify-between sm:px-24 px-16 pt-24 bg-black"
    >
        <div className="flex md:w-[70%] w-full flex-col items-center">
            <div className="md:text-6xl lg:text-8xl sm:text-7xl text-5xl  text-cyan-600  text-center">
               TOTAL PRIZEPOOL   
            </div> 
            ...
            <div className="flex lg:w-[70%] w-full justify-center md:mt-24">
                <PrizeCard Rank="1st Place" Price="₹15,000"/>
            </div>
            <div className="lg:w-[70%] w-full flex-wrap flex gap-x-8 sm:justify-between justify-center">
                <PrizeCard Rank="2st Place" Price="₹10,000"/>
                <PrizeCard Rank="3st Place" Price="₹5,000"/>
            </div>
        </div>
